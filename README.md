...
- Account Page: Is there so that the user can manage their account details.
- Enquiry Page: Where users can send any requests or questions they might have.
- Added JavaScript to improve functionality and add more to th website.
